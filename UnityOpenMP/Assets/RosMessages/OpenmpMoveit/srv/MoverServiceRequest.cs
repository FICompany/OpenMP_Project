...
namespace RosMessageTypes.OpenmpMoveit
{
    ...
    {
        public const string k_RosMessageName = "openmp_moveit/MoverService";
        public override string RosMessageName => k_RosMessageName;

        public OpenmpMoveitJointsMsg joints_input;
        public Geometry.PoseMsg pick_pose;
        public Geometry.PoseMsg place_pose;

        public MoverServiceRequest()
        {
            this.joints_input = new OpenmpMoveitJointsMsg();
            this.pick_pose = new Geometry.PoseMsg();
            this.place_pose = new Geometry.PoseMsg();
        }

        public MoverServiceRequest(OpenmpMoveitJointsMsg joints_input, Geometry.PoseMsg pick_pose, Geometry.PoseMsg place_pose)
        {
        ...
        {
            this.joints_input = OpenmpMoveitJointsMsg.Deserialize(deserializer);
