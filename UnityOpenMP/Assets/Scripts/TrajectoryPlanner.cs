...
using RosMessageTypes.OpenmpMoveit;
...
public class TrajectoryPlanner : MonoBehaviour
{
    ...
    [SerializeField]
    string m_RosServiceName = "openmp_moveit";
    public string RosServiceName { get => m_RosServiceName; set => m_RosServiceName = value; }

    [SerializeField]
    GameObject m_OpenMP;
    public GameObject OpenMP { get => m_OpenMP; set => m_OpenMP = value; }
    [SerializeField]
    GameObject m_Target;
    ...
    void CloseGripper()
    {
        ...
        leftDrive.target = 55f;
        rightDrive.target = 55f;
    ...
    /// </summary>
    /// <returns>OpenMPMoveitJoints</returns>
    OpenmpMoveitJointsMsg CurrentJointConfig()
    {
        var joints = new OpenmpMoveitJointsMsg();
    ...
    /// </summary>
    /// <param name="response"> MoverServiceResponse received from openmp_moveit mover service running in ROS</param>
    /// <returns></returns>
